    ...
    return (
        <div>
            ...
            <TextInput
                label="Phone Number"
                {...register(
                    'applicantInformation.contactInformation.phoneNumber',
                )}
                error={
                    errors.applicantInformation?.contactInformation?.phoneNumber
                }
            />
            <TextInput
                label="Email"
    ...
    return (
        <div>
            ...
            <TextInput
                ...
                error={
                    errors.projectLocationDescription
            ...
            <TextInput
                ...
                error={
                    errors.projectLocationDescription
                        ?.zoningComplianceVerification?.intendedUseDescription
                }
            />
            <Checkbox
    ...
    return (
        <div>
            ...
            <Checkbox
                ...
                {...register(
                    'buildingPlansSpecifications.requiresFireSafetyPlan',
                )}
                error={
                    errors.buildingPlansSpecifications?.requiresFireSafetyPlan
                }
            />
        </div>
    );
    ...
    return (
        <div>
            ...
            <Checkbox
                ...
                error={
                    errors.utilitiesInfrastructure?.utilityServicesRequired
                        ?.electrical
                }
            />
            <Checkbox
                label="Water"
                {...register(
                    'utilitiesInfrastructure.utilityServicesRequired.water',
                )}
                error={
                    errors.utilitiesInfrastructure?.utilityServicesRequired
                        ?.water
            ...
            <Checkbox
                label="Sewer"
                {...register(
                    'utilitiesInfrastructure.utilityServicesRequired.sewer',
                )}
                error={
                    errors.utilitiesInfrastructure?.utilityServicesRequired
                        ?.sewer
            ...
            <Checkbox
                label="Gas"
                {...register(
                    'utilitiesInfrastructure.utilityServicesRequired.gas',
                )}
                error={
                    errors.utilitiesInfrastructure?.utilityServicesRequired?.gas
                }
            />
            <FileInput
    ...
    return (
        <div>
            ...
            <Checkbox
                ...
                {...register(
                    'fireLifeSafety.fireProtectionSystems.sprinklerSystems',
                )}
                error={
                    errors.fireLifeSafety?.fireProtectionSystems
                        ?.sprinklerSystems
                }
            />
            <Checkbox
            ...
            <Checkbox
                ...
                {...register(
                    'fireLifeSafety.fireProtectionSystems.emergencyExits',
                )}
                error={
                    errors.fireLifeSafety?.fireProtectionSystems?.emergencyExits
                }
            />
            <Checkbox
    ...
    return (
        <div>
            ...
            <TextInput
                ...
                error={
                    errors.floodplainAndStormwaterManagement
                        ?.stormwaterManagementPlan?.erosionControlMeasures
                }
            />
            <FileInput
                ...
                error={
                    errors.floodplainAndStormwaterManagement
                        ?.stormwaterManagementPlan?.runoffCalculations
                }
            />
        </div>
    );
    ...
    return (
        <div>
            ...
            <FileInput
                ...
                {...register(
                    'historicPreservationReview.historicPreservationPlan',
                )}
                setValue={setValue}
                error={
                    errors.historicPreservationReview?.historicPreservationPlan
                }
            />
        </div>
    );
    ...
    return (
        <div>
            ...
            <Checkbox
                ...
                error={
                    errors.neighborNotificationAndPublicHearings
                        ?.notificationRequirements?.notifiedAdjacentOwners
                }
            />
            <Checkbox
                ...
                error={
                    errors.neighborNotificationAndPublicHearings
                        ?.notificationRequirements?.postedPublicNotices
                }
            />
            <TextInput
                ...
                error={
                    errors.neighborNotificationAndPublicHearings
                        ?.publicHearingDetails?.hearingDate
                }
            />
            <TextInput
                ...
                error={
                    errors.neighborNotificationAndPublicHearings
                        ?.publicHearingDetails?.publicCommentsReceived
                }
            />
        </div>
    );
    ...
    return (
        <div>
            ...
            <FileInput
                ...
                setValue={setValue}
                error={
                    errors.contractorAndSubcontractorDetails
                        ?.insuranceVerification?.liabilityInsuranceCertificate
                }
            />
            <FileInput
    ...
    return (
        <div>
            ...
            <Checkbox
                ...
                {...register(
                    'finalReviewAndCertification.certificationStatement',
                )}
                error={
                    errors.finalReviewAndCertification?.certificationStatement
                }
            />
            <TextInput
